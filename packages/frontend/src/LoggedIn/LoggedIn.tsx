  ...
  render() {
    return (
      <div className="App">
        ...
        <p className="Step01student">
          Step 1 Stake 100$ in crypto to  be eligible to gain interest
        </p>
        ...
        <p className="Line2"></p>
        <p className="Step02student">
          Step 2 Pass all Course Modules in Time Period
        </p>
